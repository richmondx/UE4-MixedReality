...
public:
	...
	void SetCameraRenderTarget(class UTextureRenderTarget2D* target, class UTextureRenderTarget2D* target2)
	{
		vrCameraRenderTarget = target;
		vrCameraRenderTarget2 = target2;
	}

	void RemoveCameraRenderTarget(class UTextureRenderTarget2D* target, class UTextureRenderTarget2D* target2)
	{
		...
		if (vrCameraRenderTarget == target2)
		{
			vrCameraRenderTarget2 = nullptr;
		}
	}
#endif
...
private:
	...
	class UTextureRenderTarget2D* vrCameraRenderTarget2 = nullptr;
#endif
