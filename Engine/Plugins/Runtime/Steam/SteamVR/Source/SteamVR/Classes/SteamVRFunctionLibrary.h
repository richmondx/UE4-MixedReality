...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "SteamVR")
		static void SetCaptureRenderTarget(class UTextureRenderTarget2D* NewTexture, UTextureRenderTarget2D * NewTexture2);

	UFUNCTION(BlueprintCallable, Category = "SteamVR")
		static void RemoveCaptureRenderTarget(class UTextureRenderTarget2D* NewTexture, UTextureRenderTarget2D * NewTexture2);
};
